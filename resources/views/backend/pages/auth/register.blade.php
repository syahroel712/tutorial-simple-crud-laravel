            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Swimoc</span>
                        </h4>
                        <p class="text-muted">Before you get started, you must login or register if you don't already
                            have an account.</p>
                        <form method="POST" action="{{ route('aksiRegister') }}" class="needs-validation" novalidate="">
                            @csrf()
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; Swimoc. Made with 💙 by <a href="https://www.instagram.com/syahroel_712/" target="_blank">Syahrul</a>
                            <div class="mt-2">
